...
- Local owner: `tech-backend-dev`
- Role contract: read [../../backend-dev.md](../../backend-dev.md) before using this skill.
...
- Handoff: 输出 implementation_result，交给 tech-code-reviewer 依次进行规格和代码质量审核。
